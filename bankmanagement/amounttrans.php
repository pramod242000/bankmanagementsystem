...
<body>
    ...
    <div class="acontainer3">
           ...
           <form action="update.php" method="post">
               ...
               <label for="adminid" style="font-family: cursive; color: white;">DEBIT ACCOUNT</label>
               <input type="text"  name="debit" placeholder="debiter account" value=<?php echo $_GET['an'];?>>
 
                
                <label for="adminname" style="font-family: cursive; color: white;">CREDIT ACCOUNT</label>
                <select name="credit">  
               <?php 
               $accountnos = $_GET['an'];
                $query = mysqli_query($conn,"SELECT * FROM persons
WHERE accountno NOT IN ($accountnos)");
